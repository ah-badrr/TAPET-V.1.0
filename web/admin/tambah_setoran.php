...
$mhs = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM mahasantri WHERE id = $id"));
...
if (isset($_POST["sert"])) {
    ...
    mysqli_query($connect, "INSERT INTO setoran (mahasantri_id, tanggal, juz, halaman, nilai, keterangan) 
                            VALUES ('$id', '$tanggal', '$juz', '$halaman', '$nilai', '$keterangan')");
    session_start();
    $_SESSION["ts"] = "";
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="pt-0 pb-0 p-3 w-100 mt-4">
                            <form method="POST">
                                <h4 class="mb-3">Tambah Data Setoran <?= $mhs['nama_mhs'] ?></h4>
                                <div class="mb-3">
