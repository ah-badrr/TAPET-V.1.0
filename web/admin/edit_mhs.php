...
if (isset($_POST["sert"])) {
    ...
    $mentor = $_POST["mentor"];
    $query = "UPDATE mahasantri SET nama_mhs='$nama', nim = '$nim' WHERE id=$id";
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="pt-0 pb-0 p-3 w-100 mt-4">
                            ...
                            <a href="mentor.php?id=<?= $idm ?>&&ide=<?= $ide ?>" class="btn btn-outline-danger"><i class="fa-solid fa-right-from-bracket"></i> Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
