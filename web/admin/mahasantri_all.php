...
$mhs = mysqli_query($connect, "SELECT mahasantri.*, user.nama,user.role FROM mahasantri INNER JOIN user ON mahasantri.mentor_id = user.id");
                ...
                <div class="content-wrapper">
                    <div class="row ">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <a href="tambah_mhs2.php?ide=<?= $ide ?>" class="btn btn-outline-success" style="float: right;"><i class="fa fa-plus"></i> Tambah</a>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;">
                                                            <a href="mahasantri.php?id=<?= $mh["id"] ?>&&idm=<?= $mh["mentor_id"] ?>&&ide=<?= $ide ?>" class="btn btn-outline-primary"><i class="fa m-0 fa-eye"></i></a>
                                                            <a href="edit_mhs2.php?id=<?= $mh["id"] ?>&&ide=<?= $ide ?>" class="btn btn-outline-warning"><i class="fa m-0 fa-pencil"></i></a>
                                                            <a href="hapus_mhs.php?id=<?= $mh["id"] ?>&&ide=<?= $ide ?>" class="btn btn-outline-danger"><i class="fa m-0 fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
