...
$set = mysqli_query($connect, "SELECT setoran.*, mahasantri.nama_mhs FROM setoran INNER JOIN mahasantri ON setoran.mahasantri_id = mahasantri.id WHERE setoran.id = $ids");
...
if (isset($_POST["sert"])) {
    ...
    mysqli_query($connect, "UPDATE setoran SET tanggal='$tanggal', juz='$juz', halaman='$halaman', nilai='$nilai', keterangan='$keterangan' WHERE id='$ids'");
    session_start();
    $_SESSION["es"] = "";
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="pt-0 pb-0 p-3 w-100 mt-4">
                            ...
                            <a href="mahasantri.php?id=<?= $id ?>&&idm=<?= $idm ?>&&ide=<?= $ide ?>" class="btn btn-outline-danger"><i class="fa-solid fa-right-from-bracket"></i> Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
