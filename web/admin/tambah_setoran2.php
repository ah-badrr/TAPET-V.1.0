...
if (isset($_POST["sert"])) {
    // Use $_POST["nama"] to get the selected mahasantri_id
    $mahasantri_id = htmlspecialchars($_POST["nama"]);
    ...
    mysqli_query($connect, "INSERT INTO setoran (mahasantri_id, tanggal, juz, halaman, nilai, keterangan) 
                            VALUES ('$mahasantri_id', '$tanggal', '$juz', '$halaman', '$nilai', '$keterangan')");
    session_start();
    $_SESSION["ts2"] = "";
                            ...
                            <form method="POST">
                                <div class="mb-3">
                                    ...
                                    <select name="nama" id="" class="form-control">
                                        ...
                                        <?php foreach ($mahasantri as $mh) { ?>
                                            <option value="<?= $mh["id"] ?>"><?= $mh["nama_mhs"] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="" name="juz">
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Halaman</label>
                                    <input type="number" class="form-control" id="" name="halaman">
                                </div>
                                <div class="mb-3">
