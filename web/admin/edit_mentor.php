...
$mentor = mysqli_query($connect, "SELECT * FROM user WHERE role = 'm' AND id = $id");
...
if (isset($_POST["sert"])) {
    ...
    mysqli_query($connect, "UPDATE user SET nama='$nama', username='$username', password='$password' WHERE id = $id");
    session_start();
    $_SESSION["eu"] = "";
    header("location: edit_mentor.php?id=$id&&ide=$ide");
...
if (isset($_POST['poto'])) {
    ...
    $query = "UPDATE user set gambar = '$gambar' WHERE id = $id";
