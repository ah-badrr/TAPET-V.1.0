...
if (isset($_POST["sert"])) {
    ...
    mysqli_query($connect, "INSERT INTO user (nama, username, password, role, gambar) VALUES ('$nama', '$username', '$password', 'm','$gambar')");
    session_start();
    $_SESSION["tu"] = "";
                    ...
                    <div class="row">
                        <div class="pt-0 pb-0 p-3 w-100 mt-4">
                            <form method="POST" enctype="multipart/form-data">
                                <h4 class="mb-3">Tambah Data Mentor</h4>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="" aria-describedby="" name="nama">
                                </div>
                                <div class="mb-3">
