...
if (isset($_POST["sert"])) {
    ...
    mysqli_query($connect, "INSERT INTO mahasantri (nim, nama_mhs, mentor_id) VALUES ('$nim', '$nama', '$mentor_id')");
    session_start();
    $_SESSION["tmh2"] = "";
                ...
                <div class="content-wrapper">
                    ...
                    <div class="pt-0 pb-0  w-100 mt-4">
                        <form method="POST" enctype="multipart/form-data">
                            <h4 class="mb-3">Tambah Data Mahasantri</h4>
                            <div class="mb-3">
